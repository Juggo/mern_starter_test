...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PostCreateWidget3 = __webpack_require__(39);
	
	var _PostCreateWidget4 = _interopRequireDefault(_PostCreateWidget3);
	...
	var PostListPage = function (_Component) {
	  ...
	  function PostListPage() {
	    ...
	    }, _this.fetchPostsByFilter = function () {
	      if (_this.refs.title.value) {
	
	        _this.props.dispatch((0, _PostActions.fetchPostsByFilter)(_this.refs.title.value, _this.refs.dateFrom.value, _this.refs.dateTo.value));
	      }
	  ...
	  _createClass(PostListPage, [{
	    ...
	    value: function render() {
	      return _jsx('div', {}, void 0, _jsx(_PostCreateWidget4.default, {
	...
	var PostList = function (_Component) {
	  ...
	  _createClass(PostList, [{
	    ...
	    value: function render() {
	      ...
	      return _jsx('div', {
	        className: 'listView'
	      }, void 0, this.props.posts.map(function (post) {
	        return _jsx(_PostListItem2.default, {
	          post: post,
	          onDelete: function onDelete() {
	            return _this2.props.handleDeletePost(post.cuid);
	          }
	        }, post.cuid);
	      }));
	    }
